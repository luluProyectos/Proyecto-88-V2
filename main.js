...
function my_keydown(e)
{
	...
	function up()
	{
		...
		if(ball_y>0){
			...
			console.log("no se cumpel la condición del up");
		}
	}
	...
	function down()
	{
		 ...
		 if(ball_y<=450){
			...
			console.log("no se cumpel la condición del down");
		}
	}
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("no se cumpel la condición del left");
		}
	}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			...
			console.log("no se cumpel la condición del right");
		}
	}
